...
#         self.p_ov = [math.exp(0.0), math.exp(1.5), math.exp(5.0), math.exp(0.1)]
...
#     steeringAngleTarget = self.f_delta(0.1,c_numeric[0], self.ego_state.steeringAngle)
...
#         self.ax2.clear()
#         self.ax2.plot(self.time_history, self.c_el_history, 'b-', linewidth=2)
